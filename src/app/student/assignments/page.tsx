      ...
      {filteredAssignments.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAssignments.map((assignment) => {
                ...
                return (
                    <div key={assignment.id} className="bg-white rounded-xl border border-gray-100 p-6 hover: transition flex flex-col h-full">
                        ...
                        <div className="mt-auto">
                            ...
                            <div className="flex gap-3">
                                <button className="flex-1 px-4 py-2 bg-gray-50 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-100 transition border border-gray-100">
                                    View Details
                                </button>
          ...
          <div className="flex flex-col items-center justify-center p-12 bg-white rounded-xl border border-gray-100 text-center">
               ...
               <p className="text-gray-500 mt-1 w-full">No assignments match your search or filter. Check back later or try a different filter.</p>
          </div>
      )}
    </div>
  );
