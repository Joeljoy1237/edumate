    ...
    return (
      <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
        <div className="w-full">
          ...
          {/* Grading System Skeleton */}
          <div className="bg-white p-6 rounded-lg border border-gray-200 mb-8">
            <Skeleton className="h-8 w-48 mb-4" />
            <div className="overflow-x-auto">
              <div className="min-w-full">
                <div className="bg-gray-50 border-b border-gray-200 p-4 flex space-x-12">
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="p-4 border-b border-gray-100 flex space-x-12"
                  >
      ...
      <div className="w-full">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage global university configuration and details.
            </p>
          </div>
          <button
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 mb-8">
          ...
          <p className="text-xs text-gray-500 mt-4">
            * Grading system modification requires super-admin privileges.
          </p>
        </div>
      </div>
    </div>
