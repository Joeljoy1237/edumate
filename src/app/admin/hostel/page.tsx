...
export default function HostelPage() {
  ...
  useEffect(() => {
    ...
    const unsubAlloc = onSnapshot(
      collection(db, "hostel_allocations"),
      (snap) => {
        setAllocations(
          snap.docs.map((d) => ({ id: d.id, ...d.data() }) as Allocation),
        );
      },
    );
      ...
      <div className="w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Manage rooms, capacity, and student allocations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 border-l-4 border-l-yellow-500">
            <div className="text-sm font-medium text-gray-500 uppercase">
              Available
            </div>
          ...
          <div className="bg-white rounded-lg p-6 w-96">
            ...
            <div className="space-y-3">
              <input
                ...
                onChange={(e) =>
                  setRoomForm({ ...roomForm, block: e.target.value })
                }
              />
              <input
                type="text"
              ...
              <input
                ...
                value={roomForm.fees}
                onChange={(e) =>
                  setRoomForm({ ...roomForm, fees: e.target.value })
                }
              />
            </div>
